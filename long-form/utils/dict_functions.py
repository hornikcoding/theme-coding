...
sys.path.append('X:\\P50 - Youth Tobacco Tracking\\2_Content Analysis\\Data\\_Python\\Ecig-themes\\scripts')

from utils import class_functions as cf
...
def create_HTML(filename, data):
    ...
    reportfile = 'X:/P50 - Youth Tobacco Tracking/2_Content Analysis/Data/_Python/Ecig-themes/scripts/report_2.html'
